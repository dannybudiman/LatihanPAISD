...
Web app interaktif untuk belajar Pendidikan Agama Islam (PAI) kelas 1 SD. Mencakup **5 Bab hingga Bab 9** lengkap dengan materi accordion, flash card dalil, animasi, dan latihan soal.
...
| Tampilan | Keterangan |
|----------|------------|
| ![Materi](Screenshot-1.png) | Tab Materi — Bab 5, accordion terbuka |
| ![Flash Card](Screenshot-2.png) | Tab Flash Card — kartu dengan teks Arab |
| ![Tugas II](Screenshot-3.png) | Tab Tugas II — pilihan ganda |
| ![Tebak Kata](Screenshot-4.png) | Tab Tebak Kata — cocokkan kiri-kanan |
